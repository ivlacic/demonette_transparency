...
Authors: I. Lacić and R. Huyghe

The dataset operationalizes transparency using distributional semantic vectors and includes both:

- Process-based transparency (T_proc)
- Family-based transparency (T_fam)
- Base-level transparency (T_base)
- Combined transparency (0.5 x z_proc + 0.5 x z_fam) (T_combined)
